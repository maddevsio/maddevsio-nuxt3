export const setCustomProperties = (elem: any, options: any, elemInToView: any, parentHeight: any) => {
  if (options.prlx3d) {
...
export const parallaxScrollHandler = (elem: any, options: any) => {
...
// CHECK FOR RESIZE
export const checkIsMobileSize = (elem: HTMLElement, options: any) => {
...
export const onScroll = (_: any, elemsProp = elems) => {
...
export default defineNuxtPlugin(nuxtApp => {
  nuxtApp.vueApp.directive('mad-parallax', {
    mounted(el, binding) {
      options = {
