...
import { CustomersCard } from '~/componentClasses/Customers/CustomersCard'
const UIButtonPowerCustom = defineAsyncComponent(() => import('~/components/shared/UIButtonPowerCustom.vue'))
...
<template>
  <section
    ...
    :class="useColorConverterToClass('slice-bg', backgroundColor)"
  >
    <div class="container customers-card-slice__cards">
      <div
        ...
        :class="useColorConverterToClass('bg', backgroundColor)"
      >
        <img
        ...
        >
          <p
            ...
            :class="useColorConverterToClass('text', backgroundColor === 'black' ? 'white' : 'black')"
          >
            "{{ card.description }}"
          </p>
        </div>
