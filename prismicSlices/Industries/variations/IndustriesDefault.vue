...
import { Industries } from '~/componentClasses/Industries/Industries'
import type { IIndustriesItem } from '~/interfaces/componentInterfaces/Industries/IIndustries'

const props = defineProps({
  industries: {
    type: Array as PropType<IIndustriesItem[]>,
    required: true,
  },
})

const industriesInstance = new Industries({ cards: props.industries })
