...
export default defineComponent({
  ...
  setup(props) {
    const colorClassNames = computed(() => ({
      sliceBackground: useColorConverterToClass('slice-bg', props.slice.primary.backgroundColor || 'white'),
      containerBackground: useColorConverterToClass('bg', props.slice.primary.backgroundColor || 'white'),
      textColor: useColorConverterToClass(
        'text',
        props.slice.primary.backgroundColor === null || props.slice.primary.backgroundColor === 'white' ? 'black' : 'white',
      ),
    }))
    ...
    return {
      image: {
        ...
        url: props.slice.primary.image.url.replace('compress,', ''),
      },

      title: transformLineSeparator(props.slice.primary.title || ''),
      description: props.slice.primary.description,
      btnText: props.slice.primary.btnText,
      btnLink: props.slice.primary.btnLink.url,
      colorClassNames,
    }
  },
})
