...
import { MainStartScreen } from '~/components/StartScreen/classes/MainStartScreen'
import type { IMainStartScreenPropTypes } from '~/components/StartScreen/interfaces/IMainStartScreen'
