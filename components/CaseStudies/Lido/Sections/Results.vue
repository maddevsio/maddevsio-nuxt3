...
const tweetId = '1498248565495418881'
</script>
<template>
  <section class="case-lido__results m-96_bottom media-m-48_bottom">
    ...
    <div class="container_middle m-48_top media-m-12_top m-96_bottom media-m-48_bottom">
      ...
      <LazyCaseStudiesUITextParagraph class="case_text-align-center case-lido__results-source-text m-12_top">
        Source: <a
...
.case-lido__results {
  .case-lido__results-source-text {
    font-size: 14px;
    line-height: 166%;
