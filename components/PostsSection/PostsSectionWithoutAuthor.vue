...
import type { PostsSectionWithoutAuthorProps } from '~/components/PostsSection/interfaces/IPostsSectionWithoutAuthor'
import { PostsSectionWithoutAuthor } from '~/components/PostsSection/classes/PostsSectionWithoutAuthor'
