...
import type { PostsSectionDefaultProps } from '~/components/PostsSection/interfaces/IPostsSectionDefault'
import { PostsSectionDefault } from '~/components/PostsSection/classes/PostsSectionDefault'
