...
import type { CardWithImageProps } from '~/components/CardWithImage/interfaces/ICardWithImage'
import { CardWithImage } from '~/components/CardWithImage/classes/CardWithImage'
