...
import type { GridLottieWithCaseStudyProps } from '~/components/PageBlocks/GridLottie/interfaces/IGridLottieWithCaseStudy'
import { GridLottieWithCaseStudy } from '~/components/PageBlocks/GridLottie/classes/GridLottieWithCaseStudy'
...
<template>
  <div class="container">
    ...
    >
      ...
      >
        <LazyPageBlocksGridLottieUICard
          v-if="!card.cardType"
          :card="card"
        />
