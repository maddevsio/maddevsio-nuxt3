...
import type { NavLinksProps } from '~/components/PageBlocks/NavLinks/interfaces/INavLinks'
import { NavLinks } from '~/components/PageBlocks/NavLinks/classes/NavLinks'
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <LazyPageBlocksNavLinksUINavLink
          :link="prevLink"
