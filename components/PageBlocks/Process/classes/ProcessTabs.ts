...
import type { IProcessTabs, ITabItem, ProcessTabsProps } from '~/components/PageBlocks/Process/interfaces/IProcessTabs'
...
export class ProcessTabs implements IProcessTabs {
  ...
  async changeActiveTab({
    ...
    event = '',
    isMobile,
  }: { $event?: MouseEvent | TouchEvent | PointerEvent, tabIndex?: number, event?: string, isMobile?: Ref<boolean> }) {
