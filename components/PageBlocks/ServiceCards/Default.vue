...
import type { ServiceCardsProps } from '~/components/PageBlocks/ServiceCards/interfaces/IServiceCards'
import { ServiceCards } from '~/components/PageBlocks/ServiceCards/classes/ServiceCards'
