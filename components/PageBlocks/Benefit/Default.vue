...
import type { BenefitCardsProps } from '~/components/PageBlocks/Benefit/interfaces/IBenefitCards'
import { BenefitCards } from '~/components/PageBlocks/Benefit/classes/BenefitCards'
