...
import type { AccordionCustomPageProps } from '~/components/PageBlocks/Accordion/interfaces/IAccordion'
import { AccordionCustomPage } from '~/components/PageBlocks/Accordion/classes/AccordionCustomPage'
