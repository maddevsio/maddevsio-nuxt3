...
import { Certificates } from '~/components/PageBlocks/Awards/classes/Certificates'
import type { CertificatesProps } from '~/components/PageBlocks/Awards/interfaces/ICertificates'

const props = defineProps({
  slice: {
    type: Object as PropType<CertificatesProps>,
    default: () => ({}),
  },
})
