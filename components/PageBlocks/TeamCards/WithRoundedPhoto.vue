...
import type { TeamCardsWithRoundedPhotoProps } from '~/components/PageBlocks/TeamCards/interfaces/ITeamCardsWithRoundedPhoto'
import { TeamCardsWithRoundedPhoto } from '~/components/PageBlocks/TeamCards/classes/TeamCardsWithRoundedPhoto'
