...
import type { TableCustomPageProps } from '~/components/Table/interfaces/ITableCustomPage'
import { TableCustomPage } from '~/components/Table/classes/TableCustomPage'
