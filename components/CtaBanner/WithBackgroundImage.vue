...
import { CtaBannerWithBackgroundImage } from '~/components/CtaBanner/classes/CtaBannerWithBackgroundImage'
import type {
  CtaBannerWithBackgroundImageProps,
} from '~/components/CtaBanner/interfaces/ICtaBannerWithBackgroundImage'
