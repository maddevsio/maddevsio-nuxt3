...
import { KeyMetricsCard } from '~/components/KeyMetrics/classes/KeyMetricsCard'
import type { IKeyMetricsProps } from '~/components/KeyMetrics/interfaces/IKeyMetricsCard'
