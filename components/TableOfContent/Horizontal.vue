...
import { HorizontalToC } from '~/components/TableOfContent/classes/HorizontalToC'
import type { HorizontalToCProps } from '~/components/TableOfContent/interfaces/IHorizontalToC'
