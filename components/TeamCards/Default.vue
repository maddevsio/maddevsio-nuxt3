...
import type { TeamCardsDefaultProps } from '~/components/TeamCards/interfaces/ITeamCardsDefault'
import { TeamCardsDefault } from '~/components/TeamCards/classes/TeamCardsDefault'
