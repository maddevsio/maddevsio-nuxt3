...
} from '~/components/TechAndTools/interfaces/ITechAndToolsCards'
import { getBigCards } from '~/components/TechAndTools/helpers/getBigCards'
import { getLittleCards } from '~/components/TechAndTools/helpers/getLittleCards'
