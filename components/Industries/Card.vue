...
import { IndustriesCard } from '~/components/Industries/classes/IndustriesCard'
import type { IndustriesCardProps } from '~/components/Industries/interfaces/IIndustriesCard'
