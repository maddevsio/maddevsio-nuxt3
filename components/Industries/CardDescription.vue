...
import type { IndustriesCardDescriptionProps } from '~/components/Industries/interfaces/IIndustriesCardDescription'
import { IndustriesCardDescription } from '~/components/Industries/classes/IndustriesCardDescription'
...
<template>
  ...
  >
    <div class="container industries-card-description__cards">
      <IndustriesUICardDescriptionItem
