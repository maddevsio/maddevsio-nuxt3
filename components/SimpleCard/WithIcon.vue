...
import { SimpleCardWithIcon } from '~/components/SimpleCard/classes/SimpleCardWithIcon'
import type { SimpleCardWithIconProps } from '~/components/SimpleCard/interfaces/ISimpleCardWithIcon'
