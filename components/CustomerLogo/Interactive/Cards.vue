...
import type { ICustomerLogoInteractiveCards } from '~/components/CustomerLogo/interfaces/ICustomerLogoInteractive'
...
<template>
  ...
  >
    <LazyCustomerLogoInteractiveCardBig
    ...
    >
      <LazyCustomerLogoInteractiveCardLittle
    ...
    <CustomerLogoInteractiveCardBig
      v-if="cards.length <= 2"
