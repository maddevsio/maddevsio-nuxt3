...
import type { CertificatesProps } from '~/components/Certificates/interfaces/ICertificates'
import { Certificates } from '~/components/Certificates/classes/Certificates'
