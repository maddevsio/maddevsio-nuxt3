...
import { ButtonOutline } from '~/components/ButtonSlice/classes/ButtonOutline'
import type { ButtonOutlineProps } from '~/components/ButtonSlice/interfaces/IButtonOutline'
