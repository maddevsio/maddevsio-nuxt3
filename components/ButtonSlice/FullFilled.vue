...
import { ButtonFullFilled } from '~/components/ButtonSlice/classes/ButtonFullFilled'
import type { ButtonFullFilledProps } from '~/components/ButtonSlice/interfaces/IButtonFullFilled'
