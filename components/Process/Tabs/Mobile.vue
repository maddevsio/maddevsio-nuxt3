  ...
  >
    <ul class="process-tabs__tabs">
      <li
        ...
        @click="changeActiveTab($event, tabIndex, 'click')"
      >
        <button class="process-tabs__tab-button">
          <img
            v-lazy-load
            loading="lazy"
            :data-src="tab.tabIcon.url"
            :alt="tab.tabName"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const themeColor = computed(() => (props.sliceBackgroundColor === 'black' ? 'black' : 'white'))
    return {
      textColor,
      themeColor,
    }
